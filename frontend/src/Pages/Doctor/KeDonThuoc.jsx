...
const KeDonThuoc = () => {
  ...
  return (
    ...
    //             <Typography><strong>Chuyên khoa:</strong> {user.chuyenKhoa}</Typography>
    //           </>
    //         )}
    //       </CardContent>
    //     )}
    ...
    <div>
      ...
      <div className='row' style={{ padding: '10px 20px' }}>
            ...
            <div className='row'>
              <div className='col-md-12'>
                <div className='profile-update-ad'>
                  <form className='form' style={{ padding: '0' }}>
                    <div className='row'>
                      <div class="input-box">
        ...
        <div className='col-md-4'>
          <div className='card-box-update-ad'>
            <h4 className='card-title-update-ad'>Thông tin bệnh án</h4>
            <div className='row'>
              <div className='col-md-12'>
                <div className='profile-update-ad'>
                  <form className='form' style={{ padding: '0' }}>
                    <div className='row'>
                      <div class="input-box">
                        ...
                        <input value={benhAn.chanDoan} readOnly />
                      </div>
                      <div class="input-box">
                        <label>Triệu chứng</label>
                        <input value={benhAn.trieuChung} readOnly />
                      </div>
                      <div class="input-box">
                        <label>Phương pháp điều trị</label>
                        <input value={benhAn.phuongPhapDieuTri} readOnly />
                      </div>
                      <div class="input-box">
                        <label>Tiền sử bệnh lý</label>
                        <input value={benhAn.tienSuBenhLy} readOnly />
                      </div>
                    </div>
                  </form>
                </div>
        ...
        <div className='col-md-4'>
          <div className='card-box-update-ad'>
            <h4 className='card-title-update-ad'>Thông tin bác sĩ điều trị</h4>
            <div className='row'>
              <div className='col-md-12'>
                <div className='profile-update-ad'>
                  <form className='form' style={{ padding: '0' }}>
                    <div className='row'>
                      ...
                      <div class="input-box">
                        ...
                        <input value={user.chuyenKhoa} readOnly />
                      </div>
                    </div>
                  </form>
                </div>
      ...
      <div className='row' style={{ padding: '10px 20px' }}>
        <div className='col-md-12'>
          <form onSubmit={handleSubmit} style={{ padding: '0' }}>
            <div className='card-box-update-ad'>
              <h4 className='card-title-update-ad'>Danh sách thuốc</h4>
              <div className='row'>
                <div className='col-md-12'>
                  <div className='profile-update-ad'>
                    <div className='row'>
