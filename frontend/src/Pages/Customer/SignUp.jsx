      ...
      <div className="p-6 bg-gray-50 flex flex-col justify-center">
        ...
        <form onSubmit={submitHandler}>
          ...
          <div className="mb-4">
            ...
            {/* repass sẽ tự kiểm tra nội dung nhập vào repass có giống pass không không làm việc với database */}
          <div className="mb-4">
            <input
              type="password"
        ...
        <div className="mb-4 flex items-center gap-2">
           { selectedFile && <figure className="w-[50px] h-[50px] mt-3 rounded-full border-2 border-solid border-primaryColor flex items-center justify-center overflow-hidden">
              <img
                src={previewURL} 
                alt=""
