                    ...
                    <div className="max-w-[1170px] mx-auto">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-[50px]">
                            ...
                            <div className="flex flex-col items-center p-4">
                              {/* Hình ảnh bác sĩ */}
                              <img
                                src="/Images/STA_BACSI/bacsi_bui-thi-truc-my.png"
                                alt="Doctor"
                            ...
                            <div className="flex flex-col">
                                ...
                                Bác sĩ Bùi Thị Trúc My tốt nghiệp Bác sĩ đa khoa tại Đại học Y dược Cần Thơ năm 2014 và có bằng Thạc sĩ Chẩn đoán hình ảnh về Chẩn đoán hình ảnh tại Đại học Y Dược Thành phố Hồ Chí Minh. Với hơn 10 năm kinh nghiệm trong lĩnh vực Chẩn đoán hình ảnh, Bác sĩ My luôn được nhiều bệnh nhân tin tưởng lựa chọn bởi chuyên môn sâu rộng, sự chuyên nghiệp trong công việc và tận tâm với nghề.
                                </p>
