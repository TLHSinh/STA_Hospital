...
const DSBenhAn = () => {
  ...
  const sortData = (type) => {
    ...
    if (type === 'sttT') {
      ...
      sortedData = benhAnList.map((item, index) => ({ ...item, stt: index + 1 }));
    } else if (type === 'sttG') {
      ...
      <div className="overflow-hidden bg-white shadow-md rounded-lg">
        <table className="min-w-full border-collapse">
          <thead className="bg-gradient-to-r from-blue-500 to-blue-400 text-white">
            <tr>
              <th className="p-4 text-left uppercase text-lg tracking-wide font-semibold border-b border-gray-200">STT</th>
          ...
          <tbody>
            {loading ? (
              ...
              benhAnList.map((benhAn, index) => (
                <tr key={benhAn._id} className="hover:bg-blue-100 transition-colors">
                  ...
                  <td className="p-3 border text-center space-x-3">
                    <button
                      ...
                      onClick={() => navigate(`/customer/chitietbenhans/${benhAn._id}`)}
                    >
              ...
              <tr>
                <td colSpan="6" className="p-4 text-center">Không có bệnh án nào.</td>
              </tr>
            )}
          </tbody>
        </table>
